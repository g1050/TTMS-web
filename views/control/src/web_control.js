...
class Stf_Search{
    constructor(){
        ...
        this.url_input = 'http://gaoxingkun.top:8888/user/retrieve';
        this.url_but = 'http://gaoxingkun.top:8888/user/retrieve/name'
    ...
    sea_name(req_method){
        ...
        //否则进行精确查询
            ...
            ajax(this.url_but,'GET',`emp_name=${this.input.value}`,'json',this.callback)
        }
...
`
    console.log(data);
    let stf_ser = document.querySelector('.stf_ser');
    stf_ser.value = '';
